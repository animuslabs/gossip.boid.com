...
async function getHighlighter(options = {}) {
  const highlighter = await getHighlighter$1(options);
...
export { addClass, createDiffProcessor, createFocusProcessor, createHighlightProcessor, createRangeProcessor, defineProcessor, getHighlighter, postProcess, process };
